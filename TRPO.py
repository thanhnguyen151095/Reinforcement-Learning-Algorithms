...
def TRPO(env_name="Hopper-v4", hidden_sizes= [64]+[64],seed = 0, steps_per_epoch = 4000, epochs = 50, gamma = 0.99,
...
if __name__ == '__main__':
    ...
    env_name = 'CartPole-v1' #HalfCheetah-v2' #InvertedDoublePendulum-v2'#"Hopper-v2" #'InvertedDoublePendulum-v2' #'CartPole-v1' #'InvertedPendulum-v2' #
    hidden_sizes = [64] + [64]
    seed = 0
    ...
    TRPO(env_name, hidden_sizes,seed, steps_per_epoch, epochs, 
